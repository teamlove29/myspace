...
export default function Overview() {
  ...
  return (
    <FriendPage>
      ...
      {typeMember === 1 && (
        <>
          <div className="row container-fluid text-light mb-3">
          ...
          <div className="row  col-md-auto justify-content-center">
            <div className="col-auto col-md-3 col-lg-3 col-xl-2">
              <Link
                href="/[username]/playlist/1234"
                as={`/${dataFriend.mem_display_name}TRAROKINGs/playlist/1234`}
              >
                <a>
                  <div
                    style={{
      ...
      {typeMember === 2 && (
        <>
          ...
          <div className="row container-fluid text-light">
            <h6 className="font-Medium">Album</h6>{" "}
            <p className="ml-auto text-muted">View All</p>
          </div>
          <div className="row  col-md-auto justify-content-center">
            <div className="col-auto col-md-3 col-lg-3 col-xl-2">
              <div
          ...
          {/* begin My Video */}
          <div className="row container-fluid  text-light">
            <h6 className="font-Medium">Video</h6>
            <p className="ml-auto text-muted">View All</p>
          </div>
          <div className="row  col-md-auto justify-content-center">
            <div className="col-auto col-md-3 col-lg-3 col-xl-2">
