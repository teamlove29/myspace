      ...
      >
        ...
        <div className="card-hr">
          ...
          <div className="row justify-content-center">
            ...
            <div className="col-auto col-sm-auto col-md-auto col-lg-auto col-xl-auto hide2">
              <div className=" shadow mb-4 cardHeight border-0">
                <img
                  className="rounded cardHeight"
            ...
            <div className="col-auto col-sm-auto col-md-auto  col-lg-auto col-xl-auto hide3">
              <div className=" shadow mb-4 cardHeight border-0">
                <img
                  className="rounded cardHeight"
            ...
            <div className="col-auto col-sm-auto col-lg-auto  col-xl-auto hide4">
              <div className=" shadow mb-4 cardHeight border-0">
                <img
                  className="rounded cardHeight"
            ...
            {/* <div className="col-auto col-sm-auto col-lg-auto col-xl-2 d-none  d-xl-block ">
              <div className=" shadow mb-4 cardHeight border-0">
                <img
                  className="rounded cardHeight"
