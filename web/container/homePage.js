  ...
  return (
    <div className="container-fluid">
      ...
      >
        ...
        <div className="row container col-md-auto text-light mt-4 mb-2">
        ...
        <div className="row  justify-content-center ">
          ...
          <div className="col-4  col-sm-4 col-md-4 col-lg-4  col-xl-2 d-none  d-sm-block">
            <div className="card shadow mb-4 cardHeight border-0">
              <img
                className="cardHeight"
          ...
          <div className="col-auto col-xl-2 col-lg-3  d-none  d-xl-block">
            <div className="card shadow mb-4 cardHeight border-0">
              <img
                className="cardHeight"
