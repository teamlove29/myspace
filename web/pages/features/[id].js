...
<CarouselFeature />
      <div className="container  justify-content-center mt-5">
        <small className="text-warning ">ศ.07.01.63</small>
        <h6 className="text-light font-Regular">Features Name </h6>
        ...
        <div className="row mt-4 mb-5">
          ...
          <div className="col-4 row ml-1">
            <div className="ml-auto">
              <h6 className="text-light font-Regular mb-4">You may also like</h6>
              <div
