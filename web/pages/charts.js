  ...
  return (
    <>
      ...
      <div className="row container-fluid mx-auto">
        <div className="col-6 col-sm-3 col-md-3 col-lg-3 col-xl-auto  mb-4">
          <img
            ...
            alt=""
          />
          <p className="font-13-Regular mt-3 text-light mb-0">TELEVIZON EP</p>
          <small className="text-muted small">62642 listeners</small> <br />
          <small className="text-muted small">21 Apr 2017 10 tracks</small>
        </div>
        ...
        <div className="col-6 col-sm-3 col-md-3 col-lg-3 col-xl-auto  mb-4 ">
          <img
            ...
            alt=""
          />
          <p className="font-13 mt-3 text-light mb-0">SWitch Up By Redxeeio</p>
          <small className="text-muted small">12345 listeners</small> <br />
          <small className="text-muted small">21 Apr 2017 10 tracks</small>
        </div>
        <div className="col-6 col-sm-3 col-md-3 col-lg-3 col-xl-auto  mb-4">
          <img
            ...
            alt=""
          />
          <p className="font-13 mt-3 text-light mb-0">Never Stop</p>
          <small className="text-muted small">12345 listeners</small> <br />
          <small className="text-muted small">21 Apr 2017 10 tracks</small>
        </div>
        <div className="col-6 col-sm-3 col-md-3 col-lg-3 col-xl-auto  mb-4 ">
        ...
        <div className="col-6 col-sm-3 col-md-3 col-lg-3 col-xl-auto  mb-4 ">
          <img
            className="rounded card-body-music"
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRdTY9bGsSJtoMQSgX4Ard0bwzYchCZbIxkhA&usqp=CAU"
            alt=""
          />
          <p className="font-13 mt-3 text-light mb-0">SWitch Up By Redxeeio</p>
          <small className="text-muted small">12345 listeners</small> <br />
      ...
      <div className="container-fluid">
        ...
        <div className="row mt-5  ">
            ...
            <ol className="text-light row col-12">
              <li className="col-12 col-md-6">
                <div className="row ">
                  ...
                  <div className="col-4">
                    <span className="text-warning">Varsity</span>
                    <br />
          ...
          <div className="col-md-6 ">
            <ol className="text-light"></ol>
          </div>
        </div>
        <p className="text-center text-showmore text-warning font-Medium mt-1 mb-5">
          SHOW MORE
        </p>
      </div>
