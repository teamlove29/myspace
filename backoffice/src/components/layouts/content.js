          ...
          <div className="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div className="d-flex align-items-center flex-wrap mr-1">
              ...
              <div className="d-flex align-items-baseline mr-5">
                {/*begin::Page Title*/}
                <h5 className="text-dark font-weight-bold my-2 mr-5">Tabbed Subheader</h5>
                {/*end::Page Title*/}
                {/*begin::Breadcrumb*/}
                <ul className="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                  <li className="breadcrumb-item">
                    <a href className="text-muted">Subheaders</a>
                  </li>
                  <li className="breadcrumb-item">
                    <a href className="text-muted">Classic</a>
                  </li>
                </ul>
                {/*end::Breadcrumb*/}
              </div>
                ...
                <div className="card card-custom card-stretch gutter-b">
                  ...
                  <div className="card-header align-items-center border-0 mt-4">
                    <h3 className="card-title align-items-start flex-column">
                      <span className="font-weight-bolder text-dark">Recent Activities</span>
                  ...
                  <div className="card-body pt-4">
                    <div className="timeline timeline-5 mt-3">
                      ...
                      <div className="timeline-item align-items-start">
                        {/*begin::Label*/}
                        <div className="timeline-label font-weight-bolder text-dark-75 font-size-lg text-right pr-3">08:42</div>
                        {/*end::Label*/}
                        {/*begin::Badge*/}
                        ...
                        {/*end::Badge*/}
                        {/*begin::Text*/}
                        <div className="timeline-content text-dark-50">Outlines of the recent activities that happened last weekend</div>
                        {/*end::Text*/}
                      </div>
                      {/*end::Item*/}
                      {/*begin::Item*/}
                      <div className="timeline-item align-items-start">
                        {/*begin::Label*/}
                        <div className="timeline-label font-weight-bolder text-dark-75 font-size-lg text-right pr-3">3 hr</div>
                        {/*end::Label*/}
                        {/*begin::Badge*/}
                        <div className="timeline-badge">
                        ...
                        <div className="timeline-content d-flex">
                          <span className="mr-4 font-weight-bolder text-dark-75">AEOL meeting with</span>
                          {/*begin::Section*/}
                          <div className="d-flex align-items-start mt-n2">
                            {/*begin::Symbol*/}
                            <a href="#" className="symbol symbol-35 symbol-light-success mr-2">
                      ...
                      <div className="timeline-item align-items-start">
                        {/*begin::Label*/}
                        <div className="timeline-label font-weight-bolder text-dark-75 font-size-lg text-right pr-3">14:37</div>
                        {/*end::Label*/}
                        {/*begin::Badge*/}
                        <div className="timeline-badge">
                        ...
                        {/*end::Badge*/}
                        {/*begin::Desc*/}
                        <div className="timeline-content font-weight-bolder text-dark-75">Submit initial budget -
                    <a href="#" className="text-primary">USD 700</a>.</div>
                        {/*end::Desc*/}
                      </div>
                      {/*end::Item*/}
                      {/*begin::Item*/}
                      <div className="timeline-item align-items-start">
                        {/*begin::Label*/}
                        <div className="timeline-label font-weight-bolder text-dark-75 font-size-lg text-right pr-3">16:50</div>
                        {/*end::Label*/}
                        {/*begin::Badge*/}
                        <div className="timeline-badge">
                          <i className="fa fa-genderless text-danger icon-xxl" />
                        ...
                        {/*end::Badge*/}
                        {/*begin::Text*/}
                        <div className="timeline-content text-dark-50">Stakeholder meeting scheduling.</div>
                        {/*end::Text*/}
                      </div>
                      {/*end::Item*/}
                      {/*begin::Item*/}
                      <div className="timeline-item align-items-start">
                        {/*begin::Label*/}
                        <div className="timeline-label font-weight-bolder text-dark-75 font-size-lg text-right pr-3">17:30</div>
                        {/*end::Label*/}
                        {/*begin::Badge*/}
                        <div className="timeline-badge">
                          <i className="fa fa-genderless text-success icon-xxl" />
                        ...
                        {/*end::Badge*/}
                        {/*begin::Text*/}
                        <div className="timeline-content text-dark-50">Project scoping &amp; estimations with stakeholders.</div>
                        {/*end::Text*/}
                      </div>
                      {/*end::Item*/}
                      {/*begin::Item*/}
                      <div className="timeline-item align-items-start">
                        {/*begin::Label*/}
                        <div className="timeline-label font-weight-bolder text-dark-75 font-size-lg text-right pr-3">21:03</div>
                        {/*end::Label*/}
                        {/*begin::Badge*/}
                        <div className="timeline-badge">
                        ...
                        {/*end::Badge*/}
                        {/*begin::Desc*/}
                        <div className="timeline-content font-weight-bolder text-dark-75">New order placed
                    <a href="#" className="text-primary">#XF-2356</a>.</div>
                      ...
                      <div className="timeline-item align-items-start">
                        {/*begin::Label*/}
                        <div className="timeline-label font-weight-bolder text-dark-75 font-size-lg text-right pr-3">21:07</div>
                        {/*end::Label*/}
                        {/*begin::Badge*/}
                        <div className="timeline-badge">
                          <i className="fa fa-genderless text-danger icon-xxl" />
                        ...
                        {/*end::Badge*/}
                        {/*begin::Text*/}
                        <div className="timeline-content text-dark-50">Company BBQ to celebrate the last quater achievements and goals.</div>
                        {/*end::Text*/}
                      </div>
                      {/*end: Item*/}
                      {/*begin::Item*/}
                      <div className="timeline-item align-items-start">
                        ...
                        {/*end::Badge*/}
                        {/*begin::Text*/}
                        <div className="timeline-content text-dark-50">Marketing campaign planning with customer.</div>
                        {/*end::Text*/}
                      </div>
                      {/*end::Item*/}
                    </div>
              ...
              <div className="col-lg-6 col-xxl-4">
                ...
                <div className="card card-custom card-stretch card-stretch-half gutter-b">
                  ...
                  <div className="card-body p-0">
                    ...
                    <div id="kt_stats_widget_11_chart" className="card-rounded-bottom" data-color="success" style={{ height: 150 }} />
                  </div>
                  {/*end::Body*/}
                </div>
                {/*end::Stats Widget 11*/}
                ...
                <div className="card card-custom card-stretch card-stretch-half gutter-b">
                  ...
                  <div className="card-body p-0">
                    ...
                    <div id="kt_stats_widget_12_chart" className="card-rounded-bottom" data-color="primary" style={{ height: 150 }} />
                  </div>
                  {/*end::Body*/}
                </div>
                {/*end::Stats Widget 12*/}
                      ...
                      <table className="table table-borderless table-vertical-center">
                        <thead>
                          <tr>
                            ...
                            <th className="p-0" style={{ minWidth: 125 }} />
                            <th className="p-0" style={{ minWidth: 110 }} />
              ...
              <div className="col-lg-6 col-xxl-4 order-1 order-xxl-2">
                ...
                <div className="card card-custom card-stretch gutter-b">
                  ...
                  <div className="card-header border-0">
                    ...
                    <div className="card-toolbar">
                      <div className="dropdown dropdown-inline">
                        <a href="#" className="btn btn-light-primary btn-sm font-weight-bolder dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Create</a>
                        <div className="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                          {/*begin::Navigation*/}
                          <ul className="navi navi-hover">
                            <li className="navi-header pb-1">
                ...
                <div className="card card-custom card-stretch gutter-b">
                  ...
                  <div className="card-body d-flex flex-column">
                    <div className="flex-grow-1">
                      <div id="kt_mixed_widget_14_chart" style={{ height: 200 }} />
                    </div>
                    <div className="pt-5">
                        ...
                        <table className="table table-head-custom table-head-bg table-borderless table-vertical-center">
                          <thead>
                            <tr className="text-left text-uppercase">
                              ...
                              <th style={{ minWidth: 100 }}>earnings</th>
                              <th style={{ minWidth: 100 }}>comission</th>
                              <th style={{ minWidth: 100 }}>company</th>
                              <th style={{ minWidth: 130 }}>rating</th>
